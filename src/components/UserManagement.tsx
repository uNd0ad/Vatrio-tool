...
export default function UserManagement({ onClose }: { onClose: () => void }) {
  ...
  async function remove(user: ManagedUser) {
    if (!window.confirm(`Ștergi definitiv contul ${user.email}?`)) return;
    setError(null);
