...
-- (aliniate la schema reală: listing_url/date_scraped, fără coloane inexistente)
...
comment on column public.listings.listing_url is 'Canonical external portal URL.';
...
comment on column public.listings.date_scraped is 'Timestamp when listing was first scraped.';
